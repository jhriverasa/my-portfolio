  ...
  return (
    <div className="flex flex-col text-teal-small" data-aos="fade-up">
      ...
      <div>
        ...
        mejorar nuestra calidad de vida, ya sea mejorando las interacciones
        sociales, ayudando a otros a superar dificultades o discapacidades, a
        divertirnos jugando videojuegos o viendo algún video interesante pero
